...
#
# בלי \b בכוונה: קו תחתון נחשב תו-מילה, ולכן 'רופאים_6.10.26' לא הכיל
# גבול-מילה לפני הספרה והתאריך לא זוהה. שם קובץ עם קו תחתון ייצר אז
# exam_name קנוני שונה משם זהה עם רווח — הייבוא נשמר תחת מפתח אחד
# והסריקה חיפשה את השני. השמירה היחידה שנדרשת היא לא להיתפס באמצע
# רצף ספרות ארוך, וזה מה שה-lookaround עושה.
